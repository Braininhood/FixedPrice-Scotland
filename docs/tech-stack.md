...
**Deployment:** AWS EC2 Free Tier (Frontend & Backend)
...
**Deployment:** AWS EC2 (via PM2 + Nginx)
...
**Deployment:** AWS EC2 (via Systemd + Nginx)
...
- **CORS:** Whitelist only AWS EC2 frontend domain
